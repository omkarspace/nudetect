...
def predict_per_frame():
    ...
    model = tensorflow.keras.models.load_model('saved_model.h5', custom_objects={'KerasLayer': hub.KerasLayer})
...
def video_to_output(out):
    video_processing_operations.blur_frames('./inputs/frames/1/', './output/frames/', out)
    video_processing_operations.frames_to_video('./output/frames/', 30, './output/video/')
